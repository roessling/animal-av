...
public class EDF_preemptive_Scheduling implements ValidatingGenerator {
    ...
    public String generate(AnimationPropertiesContainer props,Hashtable<String, Object> primitives) {
      ...
      if(primitives==null) {
        ...
        ProcessSchedulingEDF ps = null;
    		if(props==null) {
          ps = new ProcessSchedulingEDF(this, lang, list, maxTime, null, null, null, null);
    		} else {
          ps = new ProcessSchedulingEDF(this, lang, list, maxTime,
    ...
    public String getName() {
        return "Earliest Deadline First (EDF) - preemptiv [Scheduling]";
    }

    public String getAlgorithmName() {
        return "Earliest Deadline First (EDF) - preemptiv";
    }

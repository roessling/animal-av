...
public class HanoiVisualisierung implements ValidatingGenerator {
 ...
 +"}";
    ...
    static String[] INTRO_TEXT = {"Die “Tuerme von Hanoi“ ist ein Knobelspiel, welches in seiner Urform mit 3 Staeben",
			"und beliebig vielen unterschiedlich großen Scheiben gespielt wird.",
			"Dabei sind zunächst alle Scheiben der Groeße nach sortiert auf einen der Staebe aufgesteckt.",
			...
			"und die Scheiben durch Zahlen, die auch gleichzeitig die jeweilige Groeße der Scheibe angeben.",
			"",
	...
	static String[] OUTRO_TEXT = {"Der Algorithmus hat nun alle Scheiben erfolgreich auf Stab C verschoben.",
			...
			"Zu keinem Zeitpunkt lag eine groeßere auf einer kleineren Scheibe",

...
public class JuliaSet implements ValidatingGenerator {
    ...
    public boolean validateInput(AnimationPropertiesContainer animationPropertiesContainer, Hashtable<String, Object> primitives) throws IllegalArgumentException {
        ...
        cRe = (double) primitives.get("cRe");
        cIm = (double) primitives.get("cIm");
    ...
    public JuliaSet(String resPrefix, Locale locale) {
        this.locale = locale;
    ...
    public void init() {
        ...
        this.lang = new AnimalScript("JuliaSet", "Marvin Kaster, Andre Markard", 800, 600);
    ...
    public String generate(AnimationPropertiesContainer props, Hashtable<String, Object> primitives) {
        ...
        genOutro(new Coordinates(20, 220));
    ...
    private void setupText(Coordinates orientationPoint) {
        ...
        maxIterationsText = lang.newText(new Offset(0, 0, pixelyCountText, "SW"), translator.translateMessage("maxIterations") + " " + maxIterations, "maxIterations", null, textProps);
        mCText = lang.newText(new Offset(0, 0, maxIterationsText, "SW"), translator.translateMessage("mC") + " " + mC.toStringShort(), "outro4", null, textProps);
        zCountText = lang.newText(new Offset(0, 0, mCText, "SW"), translator.translateMessage("zIterations") + " " + zCount, "outro4", null, textProps);
        ...
        sC.addCodeLine("public void juliaSet() {", null, 0, null);
        ...
        sC.addCodeLine("ComplexNumber2 z = new ComplexNumber2(re, im);", null, 6, null);
        ...
        sC.addCodeLine("z.add(c);", null, 8, null);
        sC.addCodeLine("}", null, 6, null);

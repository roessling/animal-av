 ...
 *
 */
public class Skalierung_Inhalt {
     ...
     */
    public Skalierung_Inhalt(Language l) {
...
//	setzeProperties(arrayProps, scProps, matrixProps, headerProps, normalTextProps, rechenzeichenProps, markierterNormalTextProps, markiertMatrixProps, markierteRechenzeichenProps, pfeilProps, dreieckProps, polyProps);
    ...
    public void letzteFolie(int anzahlEcken) {
    	...
    	Text text_header = lang.newText(new Coordinates(koord_x, 13), "Affine Abbildungen: Skalierung", "trans", null, headerProps);
    ...
    /**
     * erste Iteration abgeschlossen. nicht smooth aber funtzt
     * @param a
     * @param x
     */
    public void skalierung(double[][] a, int[][] urbild_punkte) {
    	...
    	Text text_header = lang.newText(new Coordinates(koord_x, 0), "Affine Abbildungen: Skalierung", "scher", null, headerProps);
    	
    		//Nun kommt der gesamte Text
    	Text text_teil1 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + zeilenabstand),
    			"Die Skalierung stellt eine Größenänderung eines Objektes dar.",
    			"text", null, normalTextProps);
		Text text_teil2 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + zeilenabstand + 9),
    			"Die benötigten Parameter sind im dreidimensionalen Raum a00, a11 und a22, die jeweils beschreiben,",
    			"text", null, normalTextProps);
		Text text_teil3 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + zeilenabstand),
    			"um welchen Wert die jeweiligen Achsen gestreckt werden.",
    			"text", null, normalTextProps);
    	...
    	StringMatrix bspM_1 = lang.newStringMatrix(new Coordinates(koord_x+50, koord_y = koord_y + 4*zeilenabstand), beispielmatrix_1, "a", null, matrixProps);
    	StringMatrix bspM_2 = lang.newStringMatrix(new Coordinates(koord_x+150, koord_y), beispielmatrix_2, "b", null, matrixProps);
    	StringMatrix bspM_3 = lang.newStringMatrix(new Coordinates(koord_x+350, koord_y), beispielmatrix_3, "c", null, matrixProps);
    	StringMatrix bspM_4 = lang.newStringMatrix(new Coordinates(koord_x+500, koord_y), beispielmatrix_4, "d", null, matrixProps);
		...
		koord_y = koord_y - 5*zeilenabstand;
    	...
    	Text text_teil4_1 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + 2*zeilenabstand),
    			"Zuerst werden die Parameter",
    			"text", null, normalTextProps);
    	Text text_teil4_2 = lang.newText(new Coordinates(koord_x = koord_x + 225, koord_y),
    			" a01, a02, a10, a12, a20 und a21",
    			"text", null, markierterNormalTextProps);
    	Text text_teil4_3 = lang.newText(new Coordinates(koord_x = koord_x + 258, koord_y),
    			" auf 0 gesetzt.",
    			"text", null, normalTextProps);
    	koord_x = koord_x0;
		...
		bspM_2.hide();
		String[][] beispielmatrix_2_neu = {{"a00","0","0"},{"0","a11","0"},{"0","0","a22"}};
		...
		Text text_teil5_1 = lang.newText(new Coordinates(koord_x, koord_y),
    			"a00, a11 und a22 ", "text", null, markierterNormalTextProps);
		Text text_teil5_2 = lang.newText(new Coordinates(koord_x +145, koord_y),
    			"werden je nach gewünschter Scherung gesetzt.", "text", null, normalTextProps);
	
		lang.nextStep();
		
		bspM_2.hide();
		DoubleMatrix m_A = lang.newDoubleMatrix(pos_bspM_2, matrixPrepareSkalierung(a), "b", null, markiertMatrixProps);
		...
		m_A = lang.newDoubleMatrix(pos_bspM_2, matrixPrepareSkalierung(a), "b", null, matrixProps);
		
		Text text_teil7_1 = lang.newText(new Coordinates(koord_x, koord_y),
    			"Als nächstes wird der", "text", null, normalTextProps);
		Text text_teil7_2 = lang.newText(new Coordinates(koord_x = koord_x + 166, koord_y),
		...
		text_teil7_1.hide(); text_teil7_2.hide(); text_teil7_3.hide();m_urbild.hide();
		...
		Text text_teil6_3 = lang.newText(new Coordinates(koord_x = koord_x + 168, koord_y),
		...
		m_urbild.hide(); text_teil7_1.hide(); text_teil7_2.hide(); text_teil7_3.hide();text_multiplikationszeichen.hide();
		m_urbild = lang.newDoubleMatrix(pos_bspM_3, x, "c", null, matrixProps);
		...
		m_A = lang.newDoubleMatrix(pos_bspM_2, matrixPrepareSkalierung(a), "b", null, markiertMatrixProps);
		...
		double[][] zwischenresult = matrixMultiplikation(matrixPrepareSkalierung(a), x);
		DoubleMatrix m_zwiRes = lang.newDoubleMatrix(new Coordinates(koord_x+300, koord_y + 2 *zeilenabstand +7), zwischenresult, "b", null, markiertMatrixProps);
    	...
    	m_zwiRes.moveTo("E", "translate", new Coordinates(koord_x+350, koord_y -15), new MsTiming(10), new MsTiming(1000));
		...
		lang.nextStep(10);
     	...
     	m_zwiRes = lang.newDoubleMatrix(new Coordinates(koord_x+400, koord_y + 2 *zeilenabstand +7), zwischenresult, "b", null, markiertMatrixProps);
		...
		text_teil10.hide(); text_teil10_1.hide(); text_teil10_2.hide();
     	...
     	m_zwiRes.moveTo("E", "translate", new Coordinates(koord_x+400, koord_y + 2 *zeilenabstand +23), new MsTiming(10), new MsTiming(1000));
     	
     	m_zwiRes.moveTo("E", "translate", new Coordinates(180, 207), new MsTiming(1000), new MsTiming(1000));
    ...
    public void skalierung_restlichePunkte_schnell(int[][] urbild_punkte, double[][] abbm) {
    	int x = 100;
    	...
    	for (int i = 0; urbild_punkte[0].length > i; i++) {
    		...
    		counter_visuell = lang.newText(new Coordinates(25, 60),
        			"Punkt "+(i+1)+":",
        			"scher", null, normalTextProps);
    		double[][] temp_punkt = skalierung_schnell(aktueller_punkt, abbm);
...
//	           
    ...
    public double[][] skalierung_schnell(int[][] urbild_punkte, double[][] abbm) {
    	//dieser Block wird in jeder Methode lokal erneut deklariert.
    	int koord_x = 20;
    	int koord_y = 80;
    	int zeilenabstand = 25;
		...
		resultat = matrixRunden(matrixMultiplikation(matrixPrepareSkalierung(abbm), x));
...
//    	 markierterNormalTextProps.set(AnimationPropertiesKeys.COLOR_PROPERTY, Color.RED);
    ...
    public double[][] matrixPrepareSkalierung(double[][] a) {
    	...
    	m_prepared[0][1] = 0; m_prepared[0][2] = 0;
    	m_prepared[1][0] = 0; m_prepared[1][2] = 0;
    	m_prepared[2][0] = 0; m_prepared[2][1] = 0;
    ...
    public static void main(String[] args) {
		...
		Skalierung_Inhalt s = new Skalierung_Inhalt(l);

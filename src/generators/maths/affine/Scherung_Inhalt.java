...
public class Scherung_Inhalt {
     ...
     */
    public Scherung_Inhalt(Language l) {
...
//	setzeProperties(arrayProps, scProps, matrixProps, headerProps, normalTextProps, rechenzeichenProps, markierterNormalTextProps, markiertMatrixProps, markierteRechenzeichenProps, pfeilProps, dreieckProps, polyProps);
    ...
    public void letzteFolie(int anzahlEcken) {
    	...
    	Text text_header = lang.newText(new Coordinates(koord_x, 13), "Affine Abbildungen: Scherung", "trans", null, headerProps);
    ...
    public void scherung(double[][] a_inp, int[][] urbild_punkte_inp) {
    	//dieser Block wird in jeder Methode lokal erneut deklariert.
    	int koord_x = 20;
    	int koord_y = 40;
    	int zeilenabstand = 25;
    	...
    	double[][] urbild_punkte = matrix_intToDouble(urbild_punkte_inp);
    	...
    	Text text_header = lang.newText(new Coordinates(koord_x, 0), "Affine Abbildungen: Scherung", "scher", null, headerProps);
    	...
    	Text text_teil1 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + zeilenabstand),
    			"Bei Anwendung einer Scherung, auch Transvektion genannt, wird das Objekt verformt.",
    			"text", null, normalTextProps);
		Text text_teil2 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + zeilenabstand +9),
    			"Im dreidimensionalen Raum bleibt dabei eine Ebene des Objektes feststehend, während alle",
    			"text", null, normalTextProps);
		Text text_teil3 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + zeilenabstand),
    			"anderen Punkte in eine feste Richtung parallel zur dieser Ebene verschoben werden.",
    			"text", null, normalTextProps);	
    	...
    	StringMatrix bspM_1 = lang.newStringMatrix(new Coordinates(koord_x+50, koord_y = koord_y + 5*zeilenabstand), beispielmatrix_1, "a", null, matrixProps);
    	StringMatrix bspM_2 = lang.newStringMatrix(new Coordinates(koord_x+150, koord_y), beispielmatrix_2, "b", null, matrixProps);
    	StringMatrix bspM_3 = lang.newStringMatrix(new Coordinates(koord_x+350, koord_y), beispielmatrix_3, "c", null, matrixProps);
    	StringMatrix bspM_4 = lang.newStringMatrix(new Coordinates(koord_x+500, koord_y), beispielmatrix_4, "d", null, matrixProps);
    	
    	//wir merken uns die Position der zu ersetzenden matrix
    	Coordinates pos_bspM_4 = new Coordinates(koord_x+500, koord_y);
    	Coordinates pos_bspM_2 = new Coordinates(koord_x+150, koord_y);
    	Coordinates pos_bspM_3 = new Coordinates(koord_x+350, koord_y);
		...
		koord_y = koord_y - 11*zeilenabstand;
    	...
    	Text text_teil4_1 = lang.newText(new Coordinates(koord_x, koord_y = koord_y + 7*zeilenabstand),
    			"Zuerst werden die Parameter",
    			"text", null, normalTextProps);
    	Text text_teil4_2 = lang.newText(new Coordinates(koord_x = koord_x + 225, koord_y),
    			" a00, a11 und a22",
    			"text", null, markierterNormalTextProps);
    	Text text_teil4_3 = lang.newText(new Coordinates(koord_x = koord_x + 146, koord_y),
    			" auf 1 gesetzt.",
    			"text", null, normalTextProps);
    	koord_x = koord_x0;
		...
		bspM_2.hide();
		String[][] beispielmatrix_2_neu = {{"1.0","a01","a02"},{"a10","1.0","a12"},{"a20","a21","1.0"}};
		bspM_2 = lang.newStringMatrix(pos_bspM_2, beispielmatrix_2_neu, "b", null, markiertMatrixProps);
		
		
		lang.nextStep();
		
		text_teil4_1.hide(); text_teil4_2.hide(); text_teil4_3.hide();
		
		Text text_teil5_1 = lang.newText(new Coordinates(koord_x, koord_y),
    			"a01, a02, a10, a12, a20, a21 ", "text", null, markierterNormalTextProps);
		Text text_teil5_2 = lang.newText(new Coordinates(koord_x +235, koord_y),
    			"werden je nach gewünschter Scherung gesetzt.", "text", null, normalTextProps);
		
		lang.nextStep();
		
		bspM_2.hide();
		DoubleMatrix m_A = lang.newDoubleMatrix(pos_bspM_2, matrixPrepareScherung(a_inp), "b", null, markiertMatrixProps);
		
		
		
		lang.nextStep();
		
		m_A.hide(); text_teil5_1.hide(); text_teil5_2.hide();
		m_A = lang.newDoubleMatrix(pos_bspM_2, matrixPrepareScherung(a_inp), "b", null, matrixProps);
		
		Text text_teil7_1 = lang.newText(new Coordinates(koord_x, koord_y),
    			"Als nächstes wird der", "text", null, normalTextProps);
		Text text_teil7_2 = lang.newText(new Coordinates(koord_x = koord_x + 168, koord_y),
    			" Ursprungsvektor", "text", null, markierterNormalTextProps);
		Text text_teil7_3 = lang.newText(new Coordinates(koord_x = koord_x + 135, koord_y),
		...
		m_urbild.hide(); text_teil7_1.hide(); text_teil7_2.hide(); text_teil7_3.hide();
		...
		Text text_teil6_1 = lang.newText(new Coordinates(koord_x, koord_y),
    			"Der", "text", null, normalTextProps);
		Text text_teil6_2 = lang.newText(new Coordinates(koord_x = koord_x + 30, koord_y),
    			" Verschiebungsvektor", "text", null, markierterNormalTextProps);
		Text text_teil6_3 = lang.newText(new Coordinates(koord_x = koord_x + 169, koord_y),
    			" wird auf 0.0 gesetzt.", "text", null, normalTextProps);
		koord_x = koord_x0;
		
		bspM_4.hide();
		bspM_4 = lang.newStringMatrix(pos_bspM_4, beispielmatrix_4, "d", null, markiertMatrixProps);
		...
		bspM_4.hide();
		DoubleMatrix m_b = lang.newDoubleMatrix(pos_bspM_4, nullvektor, "d", null, markiertMatrixProps);
		
		
		lang.nextStep();
		
		text_multiplikationszeichen.hide();
		bspM_4.hide(); text_teil6_1.hide(); text_teil6_2.hide(); text_teil6_3.hide(); m_b.hide();
		m_b = lang.newDoubleMatrix(pos_bspM_4, nullvektor, "d", null, matrixProps);
    	...
    	text_multiplikationszeichen = lang.newText(new Coordinates(koord_x+315, koord_y + 6*zeilenabstand +3),
    			"*", "text", null, markierteRechenzeichenProps);
	
		m_A.hide(); m_urbild.hide();
		m_A = lang.newDoubleMatrix(pos_bspM_2, matrixPrepareScherung(a_inp), "b", null, markiertMatrixProps);
		m_urbild = lang.newDoubleMatrix(pos_bspM_3, x, "c", null, markiertMatrixProps);
		
		lang.nextStep(10);
		
		m_A.moveTo("N", "translate", new Coordinates(koord_x+150, koord_y + 3 *zeilenabstand +7), new MsTiming(10), new MsTiming(1000));
		text_multiplikationszeichen.moveTo("N", "translate", new Coordinates(koord_x+315,koord_y + koord_y -30), new MsTiming(10), new MsTiming(1000));
		
		m_urbild.moveTo("N", "translate", new Coordinates(koord_x+350, koord_y + 3 *zeilenabstand +7), new MsTiming(10), new MsTiming(1000));
		
		lang.nextStep(10);
    	
    	text_multiplikationszeichen.hide(); m_A.hide(); m_urbild.hide();
		
    	double[][] zwischenresult = matrixMultiplikation(matrixPrepareScherung(a_inp), x);
		DoubleMatrix m_zwiRes = lang.newDoubleMatrix(new Coordinates(koord_x+250, koord_y + 3 *zeilenabstand +7), zwischenresult, "b", null, markiertMatrixProps);
		...
		m_b = lang.newDoubleMatrix(pos_bspM_4, nullvektor, "d", null, markiertMatrixProps);
		
		text_additionszeichen = lang.newText(new Coordinates(koord_x+445, koord_y + 6*zeilenabstand +3),
    			"+", "text", null, markierteRechenzeichenProps);
    	...
    	m_zwiRes.moveTo("E", "translate", new Coordinates(koord_x+350,  koord_y + 3 *zeilenabstand +7), new MsTiming(10), new MsTiming(1000));
    	
    	m_b.moveTo("N", "translate", new Coordinates(koord_x+500, koord_y + 3 *zeilenabstand +7), new MsTiming(10), new MsTiming(1000));
		text_additionszeichen.moveTo("N", "translate", new Coordinates(koord_x+445,koord_y + koord_y -30), new MsTiming(10), new MsTiming(1000));
		
		lang.nextStep(10);
		
     	text_additionszeichen.hide(); m_b.hide(); m_zwiRes.hide();
     	
		m_zwiRes = lang.newDoubleMatrix(new Coordinates(koord_x+450,  koord_y + 3 *zeilenabstand +7), zwischenresult, "b", null, markiertMatrixProps);
		...
		text_teil10.hide(); text_teil10_1.hide(); text_teil10_2.hide();
     	...
     	m_zwiRes.moveTo("E", "translate", new Coordinates(koord_x+450, koord_y + koord_y -50 ), new MsTiming(10), new MsTiming(1000));
     	
     	m_zwiRes.moveTo("E", "translate", new Coordinates(180, koord_y + koord_y -65), new MsTiming(1000), new MsTiming(1000));
    	   
		lang.nextStep("Berechnung restlicher Punkte");
		
		
		text_teil1.hide(); text_teil3.hide(); text_teil2.hide();
		m_zwiRes.hide(); text_teil11.hide(); bspM_1.hide();
    ...
    public void scherung_restlichePunkte_schnell(double[][] abbm_inp, int[][] urbild_punkte) {
    	
    	double[][] abbm = abbm_inp;
    	...
    	for (int i = 0; urbild_punkte[0].length > i; i++) {
    		...
    		counter_visuell = lang.newText(new Coordinates(25, 60),
        			"Punkt "+(i+1)+":",
        			"scher", null, normalTextProps);
    		double[][] temp_punkt =  scherung_schnell(aktueller_punkt, abbm);
    ...
    public double[][] scherung_schnell(int[][] urbild_punkte, double[][] abbm) {
    	//dieser Block wird in jeder Methode lokal erneut deklariert.
    	int koord_x = 20;
    	int koord_y = 80;
    	int zeilenabstand = 25;
		...
		DoubleMatrix m_A = lang.newDoubleMatrix(new Coordinates(koord_x+150, koord_y + 3*zeilenabstand), abbm, "b", null, matrixProps);
		...
		resultat = matrixRunden(matrixMultiplikation(matrixPrepareScherung(abbm), x));
...
//    		poly_urbild.moveBy("translateNodes 1", 50, 50, new MsTiming(1000), new MsTiming(1000));
...
//    	 markierterNormalTextProps.set(AnimationPropertiesKeys.COLOR_PROPERTY, Color.RED);
    ...
    public static void main(String[] args) {
    	...
    	Language l = new AnimalScript("Affine Abbildungen - Scherung", "Team 11", 10, 10);
		Scherung_Inhalt s = new Scherung_Inhalt(l);

...
public class CubicSplineGen{
	...
	protected void init(AnimationPropertiesContainer props, Hashtable<String, Object> primitives) {
		//lang = new AnimalScript("Cubic Spline Interpolation", "Marius Süßmilch, Marvin Stiller", 800, 600);
		...
		sl_0 = new Slide(lang, "slide_0.txt", "Slide1",
				new DefaultStyle());
		sl_0.hide();
		
		sl_1 = new Slide(lang, "slide_1.txt", "Slide1",
				new DefaultStyle());	
	...
	protected void showText(int ex_nr){
		switch(ex_nr){
		case 1: lang.newText(new Coordinates(450,200), "Example 1: root function	8x^0.7", "ex1", null);
...
//				lang.newText(new Coordinates(450,240), "red: interpolated function", "red", null);
		break;
		case 2: lang.newText(new Coordinates(450,200), "Example 2: quadratic Funktion	0.001x^2 - 0.05x + 20", "ex2", null);
		break;
		case 3: lang.newText(new Coordinates(450,200), "Example 3: trigonometric function	150 * |sin(0.03x)|", "ex3", null);
		break;
		case 4: lang.newText(new Coordinates(450,200), "Example 4: Runge's example	300/(x-150)^2 + 20", "ex4", null);
		break;
		case 5: headline = lang.newText(new Coordinates(1,7), "Cubic Spline Interpolation", "animName", null, textProps);
		break;
		case 6: lang.nextStep();
			new Slide(lang, "slide_3.txt", "Slide3",
				new DefaultStyle());			
		break;
		}
	}
	...
	protected void askQuestion(int nr){
		...
		case 1:  TrueFalseQuestionModel q1 = new TrueFalseQuestionModel("q1");
		 q1.setPrompt("Can we optimize the precision of the interpolation by choosing more knots?");
		 q1.setFeedbackForAnswer(true, "Well done, increasing the numbder of knots indeed increases the precision of the interpolation");
		...
		q2.setPrompt("Where is the interpolated function ALWAYS equal to the original function?");
		q2.addAnswer("At random points", 0, "Wrong, the functions can have the same value at random points but thats not always the case");
		q2.addAnswer("At the knots", 1, "Well done, both functios have equal value at the knots!");
		q2.addAnswer("It is never exactly equal", 0, "Wrong, try again");
	...
	protected void drawFunction(int nr) { // draws the functions we want to
		lang.newText(new Coordinates(450,220), "black: original function", "black", null);					// interpolate
		askQuestion(1);
	...
	public void cubSplineInterpol(int nr) {
		...
		sl_1.hide();
		sl_2 = new Slide(lang, "slide_2.txt", "Slide2", new DefaultStyle());
		lang.newText(new Coordinates(450,240), "red: interpolated function (with 5 knots)", "red", null);
		lang.newText(new Coordinates(450,260), "orange: interpolated function (with 3 knots)", "orange", null);
		lang.newText(new Coordinates(450,320), "The error can be estimated like this: |f(x)-s(x)| <= h_max/h_min * sup|f''''(x)| * h_max^4", "error", null);

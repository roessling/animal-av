...
import generators.tree.EffectiveAVLTree;
...
public class AVLNode {
	...
	private int contentsNode, x, y, width,height,  balance;
	private AVLNode leftNode, rightNode, father;
 	private EffectiveAVLTree.TreeDirection incomingDirection;
	...
	public enum TreeDirection {
	 ...
	 /**
 	  ...
 	  */
 	 public void setLeft(AVLNode key){ 
  	 	 leftNode =   key ; 
  	 } 
	  ...
	  */	 
 	 public void setRight(AVLNode key)  { 
	 	 rightNode =   key ; 
	 } 
 	 ...
 	 public void setIncomingDirection (EffectiveAVLTree.TreeDirection dir) {
 		 incomingDirection = dir;
 	 }
 	 
 	 public EffectiveAVLTree.TreeDirection getIncomingDirection (){
	...
	public void setNodeBalance(int b) {
		balance = b;
	}
...
//		info.hide();
 	 ...
 	 */
 	public Polyline setLeftEdge (Language l, AVLNode leftNode ,Circle leftChild, int x, int y){
...
// 		poly[0] = new Coordinates(x, y + 20);
 	 ...
 	 */
 	public Polyline setRightEdge (Language l, AVLNode rightNode ,Circle rightChild, int x, int y){
 		Node[] poly = new Node[2];
...
// 		poly[0] = new Coordinates(x, y + 20);
 	 ...
 	 * @param fatherNode
 	 */
 	public void setFather (AVLNode fatherNode) {
 		father = fatherNode;
 	}
 	/**

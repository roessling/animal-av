...
public class XNorGatter implements Generator {
  ...
  public void init() {
    lang = new AnimalScript("XNOR-Gatter", "Golsa Arashloozadeh", 640, 480);
    lang.setStepMode(true);

  }

  public VHDLElement XNorOperator(char[] pinArray) {
    ...
    pins.add(pinY);
    VHDLElement elem = lang.newXNorGate(new Coordinates(20, 100), 100, 400,
        "myXNor", pins, null);
    lang.nextStep();
    ...
    elem = lang.newXNorGate(new Coordinates(20, 100), 100, 400, "myXNor", pins,
        null);
    lang.nextStep();
    ...
    for (int j = 0; j < pinArray.length; j++) {
      if (pins.get(j).getValue() == 'x') {
        pinY.setValue('x');
        elem = lang.newXNorGate(new Coordinates(20, 100), 100, 400, "myXNOr",
            pins, null);
        return elem;
  ...
  public void setTitle() {
    ...
    txtProp.set(AnimationPropertiesKeys.FONT_PROPERTY, new Font("Monospaced",
        Font.BOLD, 24));
    lang.newText(new Coordinates(130, 30), "XNOR-Gatter", "title", null,
        txtProp);
  }
  ...
  private void showSourceCode() {
    ...
    sc.addCodeLine("entity  XNOR-Gatter is", null, 0, null);
    sc.addCodeLine("port (in0,in1: in std_logic; Y : out std_logic);", null, 1,
        null);
    sc.addCodeLine("end XNOR-Gatter;", null, 0, null);
    sc.addCodeLine("", null, 0, null);
    sc.addCodeLine("architecture Verhalten of XNOR-Gatter is", null, 0, null);
    sc.addCodeLine("begin", null, 0, null);
    sc.addCodeLine("Y <= in0 xnor in1", null, 3, null);
    sc.addCodeLine("end Verhalten;", null, 0, null);
  }

  public String generate(AnimationPropertiesContainer props,
      Hashtable<String, Object> arg) {
    XNorGatter xnor = new XNorGatter();
    xnor.init();
  ...
  public static void main(String[] args) {
    ...
    ht.put("in7", "1");
    // ht.put("in8", "");
    System.err.println(xnor.generate(null, ht));
  }
}

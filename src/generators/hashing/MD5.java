...
public class MD5 implements Generator {
    ...
    // Konstante Shift Werte für jeden Durchlauf
 	...
 	// Verwende den binären Vorkommateil vom 2^32-fachen Betrag des Sinus von Integerwerten als Konstanten:
    ...
    public void init(){
        lang = new AnimalScript("MD5", "Bekir Bayrak, Halit Ciftci", 800, 600);
    ...
    public String generate(AnimationPropertiesContainer props,Hashtable<String, Object> primitives) {
	    ...
	    lang.newText(new Coordinates(20, 30), "MD5-Algorithmus",
	        "headerTitle", null, headerProps);
	    
	    RectProperties rectProps = new RectProperties();
	    rectProps.set(AnimationPropertiesKeys.FILLED_PROPERTY, true);
	    rectProps.set(AnimationPropertiesKeys.FILL_PROPERTY, Color.WHITE);
	    rectProps.set(AnimationPropertiesKeys.DEPTH_PROPERTY, 2);
	    lang.newRect(new Offset(-5, -5, "headerTitle",
	        AnimalScript.DIRECTION_NW), new Offset(5, 5, "headerTitle", "SE"), "titleRect",
	        null, rectProps);
		...
		scProps = (SourceCodeProperties)props.getPropertiesByName("sourceCode");
 		...
 		SourceCode description = lang.newSourceCode(new Offset(0, 10, "descHeader", "SW"),
 				"description", null, scProps);
 		description.addCodeLine("Der MD5-Algorithmus (Message-Digest Algorithm 5) ist eine kryptologische Hashfunktion,", null, 0, null);
 		description.addCodeLine("die 1991 von Ronald L. Rivest entwickelt wurde.", null, 0, null);
	    ...
	    SourceCode description1 = lang.newSourceCode(new Offset(0, 10, "descHeader", "SW"),
 				"description1", null, scProps);
 		description1.addCodeLine("MD5 teilt die Eingabe in Blöcke von je 512 Bit.", null, 0, null);
 		description1.addCodeLine("Jeder Block wird in 4 Runden mit jeweils 16 Operationen behandelt.", null, 0, null);
 		description1.addCodeLine("", null, 0, null);
 		description1.addCodeLine("Der Algorithmus benutzt 4 nichtlineare Funktionen, die in den jeweiligen Runden eingesetzt werden.", null, 0, null);
 		...
 		description1.addCodeLine("G(X, Y, Z) = (X AND Z) OR (Y AND NOT Z)", null, 2, null);
 		description1.addCodeLine("3. Runde", null, 1, null);
 		description1.addCodeLine("H(X, Y, Z) = X XOR Y XOR Z", null, 2, null);
 		description1.addCodeLine("4. Runde", null, 1, null);
 		description1.addCodeLine("I(X, Y, Z) = Y XOR (X OR NOT Z)", null, 2, null);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		SourceCode description2 = lang.newSourceCode(new Offset(0, 10, "descHeader", "SW"),
 				"description2", null, scProps);
 		description2.addCodeLine("1. Konstanten Array K:", null, 0, null);
 		description2.addCodeLine("Jede Runde wird zum Zwischenergebnis ein konstanter Wert dazuaddiert.", null, 1, null);
 		description2.addCodeLine("Diese Werte sind die Binäreren Vorkommateile vom 2^32-fachen Betrag des Sinus von Integerwerten.", null, 1, null);
 		description2.addCodeLine("", null, 0, null);
 		description2.addCodeLine("for (int i = 0; i < 64; i++)", null, 1, null);
 		description2.addCodeLine("K[i] = (int)(long) ((1L << 32) * Math.abs(Math.sin(i + 1)));", null, 2, null);
 		description2.addCodeLine("", null, 0, null);
 		...
 		description2.addCodeLine("7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22, 7, 12, 17, 22", null, 2, null);
 		description2.addCodeLine("5,  9, 14, 20, 5,  9, 14, 20, 5,  9, 14, 20, 5,  9, 14, 20", null, 2, null);
 		description2.addCodeLine("4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23, 4, 11, 16, 23", null, 2, null);
 		description2.addCodeLine("6, 19, 15, 21, 6, 19, 15, 21, 6, 19, 15, 21, 6, 19, 15, 21}", null, 2, null);
 		description2.addCodeLine("", null, 0, null);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		SourceCode description21 = lang.newSourceCode(new Offset(0, 10, "descHeader", "SW"),
 				"description21", null, scProps);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		Text mInput = lang.newText(new Coordinates(700, 20), "Eingabestring: '"+Message+"'",
 		        "mInput", null, bold14Props);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		Text mLength = lang.newText(new Offset(0, 5, "mInput", "SW"), "MessageLength: "+messageLenBytes+" Bytes",
 		        "mLength", null, bold14Props);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		Text mBlocks = lang.newText(new Offset(0, 5, "mLength", "SW"), "NumBlocks: "+numBlocks,
 		        "mBlocks", null, bold14Props);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		Text mTLength = lang.newText(new Offset(0, 5, "mBlocks", "SW"), "TotalLength: "+totalLen+" Bytes",
 		        "mTLength", null, bold14Props);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		Text mResult = lang.newText(new Offset(0, 5, "mTLength", "SW"), "Result",
 		        "mResult", null, bold14Props);
    ...
    public void buildMD5Visuals() {
		code = lang.newSourceCode(new Offset(0, 5, "descHeader", "SW"), "code", null, scProps);
 		...
 		code.addCodeLine("for (int j = 0; j < 64; j++) {", null, 2, null);
 		code.addCodeLine("int F = 0; g = j;", null, 3, null);
 		...
 		code.addCodeLine("g = (i * 5 + 1) & 0x0F;", null, 4, null);
 		code.addCodeLine("} else if (32 <= j && j <= 47) {", null, 3, null);
 		code.addCodeLine("F = B ^ C ^ D;", null, 4, null);
 		code.addCodeLine("g = (i * 3 + 5) & 0x0F;", null, 4, null);
 		code.addCodeLine("} else if (48 <= j && j <= 63) {", null, 3, null);
 		code.addCodeLine("F = C ^ (B | ~D);", null, 4, null);
 		code.addCodeLine("g = (i * 7) & 0x0F;", null, 4, null);
 		code.addCodeLine("}", null, 3, null);
 		code.addCodeLine("int temp = B + Integer.rotateLeft(A + F + M[g] + K[j], S[j]);", null, 3, null);
	    ...
	    /********************************* NEXT STEP *********************************/
 		...
 		tRunde = lang.newText(new Offset(0, 5, "tBlock", "SW"), "Runde: 0 / 64", "tRunde", null, bold14Props);
 		...
 		fK = lang.newText(new Offset(-120, 7, "Add3", "NW"), "K[g]: 00000000",
 		...
 		shiftResult = lang.newText(new Offset(-55, 15, "Shift", "SW"), "00000000",
 		        "shiftResult", null, plain12Props);
 		roundPrimitives.add(shiftResult);
 		
 		/***************** 4th Add *****************/
 		roundPrimitives.add(lang.newRect(new Offset(-15, 60, "Shift", AnimalScript.DIRECTION_C), new Offset(15, 90, "Shift", "C"), "Add4", null, addRectProps));
 		roundPrimitives.add(lang.newPolyline(new Node[]{ new Offset(0, 0, "ShiftRect", "S"), new Offset(0, 0, "Add4", "N") }, "lAdd4", null, lineProps));
 		roundPrimitives.add(lang.newPolyline(new Node[]{ new Offset(90, 0, "Add4", "E"), new Offset(0, 0, "Add4", "E") }, "lAdd4B", null, lineProps));
 		
 		fTemp = lang.newText(new Offset(-100, 10, "Add4", "SW"), "Temp: 00000000",
 		        "fTemp", null, plain12Props);
 		roundPrimitives.add(fTemp);
 		
 		/********************** BOTTOM A RECT **********************/
 		roundPrimitives.add(lang.newText(new Offset(0, 480, "fA", "SW"), "A", "fAz", null, bold16Props));
 		...
 		/********************** POLYLINES **********************/
 		roundPrimitives.add(lang.newPolyline(new Node[]{ new Offset(0, 0, "Add4", "S"), new OffsetFromLastPosition(0, 30), new Offset(0, -20, "fBzRect", "N"), new Offset(0, 0, "fBzRect", "N") }, "pAB", null, lineProps));
 		roundPrimitives.add(lang.newPolyline(new Node[]{ new Offset(0, 0, "fDRect", "S"), new OffsetFromLastPosition(0, 400), new Offset(0, -20, "fAzRect", "N"), new Offset(0, 0, "fAzRect", "N") }, "pDA", null, lineProps));
 		roundPrimitives.add(lang.newPolyline(new Node[]{ new Offset(0, 0, "fCRect", "S"), new OffsetFromLastPosition(0, 400), new Offset(0, -20, "fDzRect", "N"), new Offset(0, 0, "fDzRect", "N") }, "pCD", null, lineProps));
 		roundPrimitives.add(lang.newPolyline(new Node[]{ new Offset(0, 0, "fBRect", "S"), new OffsetFromLastPosition(0, 400), new Offset(0, -20, "fCzRect", "N"), new Offset(0, 0, "fCzRect", "N") }, "pBC", null, lineProps));
	...
	public void startMD5Calculation() {
		...
		for (int i = 0; i < numBlocks; i++) {
			...
			for (int j = 0; j < 64; j++) {
				...
				tRunde.setText("Runde: "+(j+1)+" / 64", null, null);
				...
				int a3Res = a2Res + TABLE_T[j];
				int sRes = Integer.rotateLeft(a3Res, SHIFT_AMTS[j]);
				int a4Res = sRes + b;
				...
				fK.setText("K["+j+"]: "+toHexString(TABLE_T[j]), null, null);
				...
				shiftResult.setText(toHexString(sRes), null, null);
				shiftResult.changeColor(null, Color.red, null, null);
				
				if(makeAnimation) lang.nextStep();
				
				shiftResult.changeColor(null, Color.black, null, null);
				fTemp.setText("Temp: "+toHexString(a4Res), null, null);
				fTemp.changeColor(null, Color.red, null, null);
				
				int temp = b + Integer.rotateLeft(a + f + M[bufferIndex] + TABLE_T[j], SHIFT_AMTS[j]);
				...
				code.unhighlight(26);
				code.highlight(27);
				fAzI.setText(toHexString(a), null, null); // "10325476"
				...
				code.unhighlight(27);
				code.highlight(28);
				fDzI.setText(toHexString(d), null, null); // "98BADCFE"
				...
				code.unhighlight(28);
				code.highlight(29);
				fCzI.setText(toHexString(c), null, null); // "EFCDAB89"
	...
	public void showConclusion() {
		...
		conclusion.addCodeLine("Bereits 1994 entdeckten Bert den Boer und Antoon Bosselaers Pseudokollisionen in MD5.", null, 0, null);
		conclusion.addCodeLine("2004 gelang es einer chinesischen Forschergruppe um Xiaoyun Wang, Kollisionen systematisch zu erzeugen, wenn der Anfang der Nachricht beliebig gewählt werden kann,", null, 0, null);
		conclusion.addCodeLine("aber bei beiden Nachrichten identisch ist (common-prefix collision).", null, 0, null);
		conclusion.addCodeLine("", null, 0, null);
		conclusion.addCodeLine("Preimage-Angriffe können noch nicht in sinnvoller Zeit durchgeführt werden. Dadurch ist es weiterhin unmöglich,", null, 0, null);
		conclusion.addCodeLine("nachträglich ein gefälschtes Dokument zu erstellen, das zu einem bestimmten, mit MD5 erzeugten Zertifikat passt.", null, 0, null);
		conclusion.addCodeLine("", null, 0, null);
		...
		conclusion.addCodeLine("https://www.ietf.org/rfc/rfc1321.txt", null, 0, null);
		conclusion.addCodeLine("http://tools.ietf.org/html/rfc6151", null, 0, null);
    ...
    public String getDescription(){
        return "Der MD5-Algorithmus (Message-Digest Algorithm 5) ist eine kryptologische Hashfunktion, die 1991 von Ronald L. Rivest entwickelt wurde. " +
    ...
    public String getCodeExample(){
        return 
        		"public static byte[] computeMD5(byte[] gesamt) {\n"+

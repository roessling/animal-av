...
public class ShannonFanoStyle {
	...
	public void fillDefaultValues() {
		...
		TextProperties charProps = (TextProperties) map.get(SYMBOL);
		if (charProps == null) {
		...
		map.put(SYMBOL, charProps);

		TextProperties noProps = (TextProperties) map.get(NODE_ID);
		if (noProps == null) {
		...
		RectProperties setProp = (RectProperties) map.get(NODE_SET);
		if (setProp == null) {
			setProp = new RectProperties();
		}
		setProp.set(AnimationPropertiesKeys.COLOR_PROPERTY, Color.RED);
		map.put(NODE_SET, setProp);
	}

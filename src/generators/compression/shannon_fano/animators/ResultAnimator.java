...
public class ResultAnimator extends ChapterAnimator {
	...
	public ResultAnimator(Language lang, ShannonFanoStyle shannonFanoStyle,
	...
	/**
	 * The shannon-fano tree and the encoding table is generated. Now show the actual
	...
	private void animateResult() {
		...
		StringArray offsetReference = lang.newStringArray(new Offset(0, 50,
				...
				"alignDummy", null, (ArrayProperties) style
		...
		inputStringLabel = lang.newText(new Offset(0, -15, offsetReference,
				...
				"inputStringLabel", null, (TextProperties) style

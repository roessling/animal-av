...
public class GenericRecursiveStraightStringSelection extends
  ...
  public GenericRecursiveStraightStringSelection(String aResourceName,
      Locale aLocale) {
  ...
  protected int search(String valueToSearchFor, int pos) {
    if (pos == 0) { // set up!
    ...
    lang.nextStep();
    if (array.getData(pos).equals(valueToSearchFor)) {

...
public class GenericIterativeStraightIntSelectionWithCounter extends
  ...
  public GenericIterativeStraightIntSelectionWithCounter(String aResourceName,
      Locale aLocale) {
  ...
  protected int search(int valueToSearchFor) {
    ...
    while (iMarker.getPosition() < nrElems
        && array.getData(iMarker.getPosition()) != valueToSearchFor) {

...
public class CFB_Generator implements Generator {
	...
	public void start() {
		...
		lang = new AnimalScript("CFB Decryption", "Tien Truong Nguyen", 800,
				600);
		...
		header = lang.newText(new Coordinates(30, 40), "CFB Decryption",
	...
	public void description() {
		...
		lang.newText(
				...
				"Cipher Feedback (CFB) Mode ist eine Betriebsart (Modus),in der Blockchiffren als ",
		...
		lang.newText(
				...
				"wie Verschluesselung, erzeugt also bei gleichem Initialisierungsvektor(IV) und",
				"description3", null, textProps);
		lang.newText(
				new Offset(0, 25, "description3", AnimalScript.DIRECTION_NW),
				"gleichem Schluessel die gleiche binaere Datenfolge mit der XOR-Operation des Sender ",
				"description4", null, textProps);
		lang.newText(
				new Offset(0, 25, "description4", AnimalScript.DIRECTION_NW),
				"rueckgaengig gemacht werden kann. Die Blockchiffre auf Sender-und Empfaengerseite ",
				"description5", null, textProps);
		lang.newText(new Offset(0, 25, "description5",
				AnimalScript.DIRECTION_NW),
				"kann fast simultan berechnet werden ", "description6", null,
				textProps);
	}
	...
	public void calculate() {
		...
		String I_2 = next_I(this.initial_vector, c_1);
		Text tx_I_2 = lang.newText(new Offset(0, scaleOfRow / 2, "I_1",
				AnimalScript.DIRECTION_SW), I_2, "I_2", null, props);
		lang.nextStep();
		...
		while (i < this.strArray.getLength() + 1) {
			...
			Text tx_i_next = lang.newText(new Offset(0, scaleOfRow / 2, "i_"
					...
					"i_" + (i + 1), null, props);
			Text tx_I_next = lang.newText(new Offset(0, scaleOfRow / 2, "I_"
					+ i, AnimalScript.DIRECTION_SW), next_I(I, c_i), "I_"
					+ (i + 1), null, props);
			i++;
			I = next_I(I, c_i);
			lang.nextStep();
	...
	public String getDescription() {
		return "Cipher Feedback Mode (CFB) ist eine Betriebsart (Modus),in der Blockchiffren als Stromchiffren betrieben werden .Die Entschl\u00fcsselung beim Empf\u00e4nger funktioniert"
				+ "\n"
				...
				+ "\n"
				+ "r\u00fckg\u00e4ngig gemacht werden kann. Die Blockchiffre auf Sender-und Empf\u00e4ngerseite kann fast simultan berechnet werden."
				+ "\n"
				+ "<br/><br/>"
				...
				+ "</li>"
				+ "                     <li>   Die L\u00e4nge von Block ist r mit Bedingung 1&#60;=r&#60;=n"
				+ "</li>"
	...
	public String getCodeExample() {
		return "function CFB_Decryption(cipherText,r,IV){"
				+ "\n"
				...
				+ "\n" + "           I_i+1=(2^r*I_i+c_i)mod 2^n; // next I"
				+ "\n" + "           }" + "\n" + " }";
	}

...
public class DESGenEN implements ValidatingGenerator {
	...
	public String getAnimationAuthor() {
		return "Andre Daube, Kokilan Kanesalingam";// <andredaube@yahoo.de>,Kokilan Kanesalingam <kajan1@hotmail.de>";
	}

	public String getDescription() {
		return "<html><head><body><p class=\"MsoNormal\"><span class=\"MsoSubtleEmphasis\"><span lang=\"EN-GB\" style=\"font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-ansi-language:EN-GB\">The <b>Data"
				+ "\n"
				+ "Encryption Standard (DES)</b> is a block cipher that uses shared secret"
				+ "\n"
				+ "encryption. It was selected by the National Bureau of Standards as an official"
				+ "\n"
				+ "Federal Information Processing Standard (FIPS) for theUnited States in 1976 and"
				+ "\n"
				...
				+ "\n"
				+ "controversial with classifieddesign elements, a relatively short key length,"
				+ "\n"
				+ "and suspicions about a National Security Agency (NSA)backdoor. DES consequently"
				+ "\n"
				+ "came under intense academic scrutiny which motivated the modern understanding"
				+ "\n"
				+ "of block ciphers and their cryptanalysis.<o:p></o:p></span></span></p></body></html>";
	}
	...
	public String getCodeExample() {
		return "#include <stdio.h>"
				...
				+ "\n"
				+ "	int sop, j, sbox[8][4][16] = { 14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5,"
				+ "\n"
				+ "			9, 0, 7, 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8, 4, 1,"
				+ "\n"
				+ "			14, 8, 13, 6, 2, 11, 15, 12, 9, 7, 3, 10, 5, 0, 15, 12, 8, 2, 4, 9,"
				+ "\n"
				+ "			1, 7, 5, 11, 3, 14, 10, 0, 6,"
				+ "\n"
				+ "			13, //64 values - SBox1"
				+ "\n"
				...
				+ "\n"
				+ "			4, 7, 13, 1, 5, 0, 15, 10, 3, 9, 8, 6, 4, 2, 1, 11, 10, 13, 7, 8,"
				+ "\n"
				+ "			15, 9, 12, 5, 6, 3, 0, 14, 11, 8, 12, 7, 1, 14, 2, 13, 6, 15, 0, 9,"
				+ "\n"
				+ "			10, 4, 5,"
				+ "\n"
				+ "			3, //SBox5"
				...
				+ "\n"
				+ "			7, 12, 9, 5, 6, 1, 12, 14, 0, 11, 3, 8, 9, 14, 15, 5, 2, 8, 12, 3,"
				+ "\n"
				...
				+ "\n"
				+ "			24, 25, 26, 27, 28, 29, 28, 29, 30, 31, 32, 1 }; //Expansion Permutation (E)"
				+ "\n"
				+ "	int Per[] = { 16, 7, 20, 21, 29, 12, 28, 17, 1, 15, 23, 26, 5, 18, 31, 10,"
				+ "\n"
				+ "			2, 8, 24, 14, 32, 27, 3, 9, 19, 13, 30, 6, 22, 11, 4, 25 }; //Permutation Function (P)"
				+ "\n"
				...
				+ "\n"
				+ "			13, 5, 28, 20, 12, 4 }; //Permuted Choice 1"
				+ "\n"
				+ "	int pc2[] = { 14, 17, 11, 24, 1, 5, 3, 28, 15, 6, 21, 10, 23, 19, 12, 4, 26,"
				+ "\n"
				+ "			8, 16, 7, 27, 20, 13, 2, 41, 52, 31, 37, 47, 55, 30, 40, 51, 45, 33,"
				+ "\n"
				+ "			48, 44, 49, 39, 56, 34, 53, 46, 42, 50, 36, 29, 32 }; //Permuted Choice 2"
				+ "\n"
				...
				+ "\n"
				+ "			49, 41, 33, 25, 17, 9, 1, 59, 51, 43, 35, 27, 19, 11, 3, 61, 53, 45,"
				+ "\n"
				+ "			37, 29, 21, 13, 5, 63, 55, 47, 39, 31, 23, 15, 7 }; //Initail Permutation (IP)"
				+ "\n"
				+ "	int iip[] = { 40, 8, 48, 16, 56, 24, 64, 32, 39, 7, 47, 15, 55, 23, 63, 31,"
				+ "\n"
				+ "			38, 6, 46, 14, 54, 22, 62, 30, 37, 5, 45, 13, 53, 21, 61, 29, 36, 4,"
				+ "\n"
				+ "			44, 12, 52, 20, 60, 28, 35, 3, 43, 11, 51, 19, 59, 27, 34, 2, 42,"
				+ "\n"
				+ "			10, 50, 18, 58, 26, 33, 1, 41, 9, 49, 17, 57, 25 }; //Inverse Initial Permutation (IP^-1)"
				+ "\n"
				+ "	gen_keys();"
				+ "\n"

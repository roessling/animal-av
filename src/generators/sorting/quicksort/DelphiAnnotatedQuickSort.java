...
public class DelphiAnnotatedQuickSort extends AnimatedIntArrayAlgorithm
  ...
  public DelphiAnnotatedQuickSort() {
    this("resources/DelphiQuickSort", Locale.GERMANY);
  }

  public DelphiAnnotatedQuickSort(String aResourceName, Locale aLocale) {

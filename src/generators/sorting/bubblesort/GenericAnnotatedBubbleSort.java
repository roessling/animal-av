...
public class GenericAnnotatedBubbleSort extends AnimatedIntArrayAlgorithm
    implements Generator {
  protected Text               swapLabel, swapPerf;
  protected InteractionFactory factory;
  protected Locale             contentLocale = null;

  public GenericAnnotatedBubbleSort(String aResourceName, Locale aLocale) {
  ...
  public void sort() {
    ...
    for (i = nrElems; swapPerformed && i > 0; i--) {
      ...
      FillInBlanksQuestionModel nrSwaps = new FillInBlanksQuestionModel(
          "swapFIB" + i);
      nrSwaps.setPrompt("How many Swaps will be done in this iteration?");
      nrSwaps.setGroupID("swaps");
      lang.addQuestionGroup(new QuestionGroupModel("swaps", 3));
      enumSwaps = 0;
      lang.addFIBQuestion(nrSwaps);
      ...
      nrSwaps.addAnswer("" + enumSwaps, 3, "The right number of Swaps is: "
          + enumSwaps);

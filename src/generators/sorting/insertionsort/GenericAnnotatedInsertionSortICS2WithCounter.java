...
public class GenericAnnotatedInsertionSortICS2WithCounter extends
    GenericAnnotatedInsertionSort {

  private TwoValueCounter counter;
  private TwoValueView    view;

  public GenericAnnotatedInsertionSortICS2WithCounter(String resourceName,
      Locale locale) {
  ...
  public void sort() {
    ...
    view = lang.newCounterView(counter, new Coordinates(500, 100), cp, true,
        true, names);

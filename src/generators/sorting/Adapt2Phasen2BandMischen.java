...
public class Adapt2Phasen2BandMischen implements Generator {
  ...
  private static final String SOURCE_CODE    = "Pseudo Code:"
                                                 + "\n1. Erstelle n Läufe"
                                                 + "\n2. Finde schon sortierte Läufe"
                                                 + "\n3. Solange es mehr als einen Lauf gibt:"
                                                 + "\n    Betrachte die 2 nächsten Läufe."
                                                 + "\n    4.1 Bis beide Läufe leer sind:"
                                                 + "\n        Füge das kleinere der vorderen Elemente der beiden Läufe in die Liste"
                                                 + "\n5. Lasse prev Zeiger wieder auf vorheriges Element Zeigen";
  ...
  public Adapt2Phasen2BandMischen() {
  }
  ...
  private SourceCode makeSC() {
    scProps.set(AnimationPropertiesKeys.COLOR_PROPERTY, Color.BLACK);
    scProps.set(AnimationPropertiesKeys.HIGHLIGHTCOLOR_PROPERTY, Color.RED);
    scProps.set(AnimationPropertiesKeys.FONT_PROPERTY, new Font(
        Font.SANS_SERIF, Font.BOLD, 16));
    SourceCode sc = lang.newSourceCode(new Coordinates(20, 50), "sc", null,
        scProps);
    sc.addCodeLine("Pseudo Code:", null, 0, null);
    sc.addCodeLine("1. Solange es mehr als einen Lauf gibt:", null, 1, null);
    sc.addCodeLine("    Betrachte die 2 nächsten Läufe.", null, 1, null);
    sc.addCodeLine("1.1 Bis beide Läufe leer sind:", null, 2, null);
    sc.addCodeLine(
        "      Füge das kleinere der vorderen Elemente der beiden Läufe in die Liste",
        null, 2, null);
    sc.addCodeLine("2. Lasse prev Zeiger wieder auf vorheriges Element Zeigen",
        null, 1, null);
    sc.hide();
    return sc;
  }

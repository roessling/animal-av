...
public class AnimatedTrie
{
	...
	public AnimatedTrie(Language lang_, Variables vars_, TrieLayout layout_, Color default_color_, Color highlight_color_, InformationDisplay info_display_)
	{
		lang = lang_;
		vars = vars_;
		layout = layout_;
	...
	public void insert(String string)
	{
		...
		inner_circle.changeColor("", highlight_color, null, null);
		lang.nextStep();

		node.circle.changeColor("", default_color, null, null);
		inner_circle.changeColor("", default_color, null, null);

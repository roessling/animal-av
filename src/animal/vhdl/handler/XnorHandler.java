...
/**
 * This class provides the operations that can be performed on Xnor.
 */
public class XnorHandler extends GraphicObjectHandler {
	public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
		Vector<String> result = new Vector<String>();

		// only works if the passed object is a PTXnor!
		if (!(ptgo instanceof PTXnor))
			return result;

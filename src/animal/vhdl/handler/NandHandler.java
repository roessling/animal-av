...
/**
 * This class provides the operations that can be performed on Nand.
 */
public class NandHandler extends GraphicObjectHandler {
	public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
		Vector<String> result = new Vector<String>();

		// only works if the passed object is a PTNand!
		if (!(ptgo instanceof PTNand))
			return result;

...
/**
 * This class provides the operations that can be performed on Mux.
 */
public class MuxHandler extends GraphicObjectHandler {
  public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
    Vector<String> result = new Vector<String>();

    // only works if the passed object is a PTMux!
    if (!(ptgo instanceof PTMux))
      return result;

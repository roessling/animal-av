...
/**
 * This class provides the operations that can be performed on Or.
 */
public class OrHandler extends GraphicObjectHandler {
	public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
		Vector<String> result = new Vector<String>();

		// only works if the passed object is a PTOr!
		if (!(ptgo instanceof PTOr))
			return result;

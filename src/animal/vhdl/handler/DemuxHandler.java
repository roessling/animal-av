...
/**
 * This class provides the operations that can be performed on Demux.
 */
public class DemuxHandler extends GraphicObjectHandler {
  public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
    Vector<String> result = new Vector<String>();

    // only works if the passed object is a PTDemux!
    if (!(ptgo instanceof PTDemux))
      return result;

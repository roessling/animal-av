...
/**
 * This class provides the operations that can be performed on Xor.
 */
public class XorHandler extends GraphicObjectHandler {
	public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
		Vector<String> result = new Vector<String>();

		// only works if the passed object is a PTXor!
		if (!(ptgo instanceof PTXor))
			return result;

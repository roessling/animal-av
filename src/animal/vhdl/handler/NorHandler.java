...
/**
 * This class provides the operations that can be performed on Nor.
 */
public class NorHandler extends GraphicObjectHandler {
	public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
		Vector<String> result = new Vector<String>();

		// only works if the passed object is a PTNor!
		if (!(ptgo instanceof PTNor))
			return result;

...
/**
 * This class provides the operations that can be performed on T.
 */
public class THandler extends GraphicObjectHandler {
	public Vector<String> getMethods(PTGraphicObject ptgo, Object obj) {
		Vector<String> result = new Vector<String>();

		// only works if the passed object is a PTT!
		if (!(ptgo instanceof PTT))
			return result;

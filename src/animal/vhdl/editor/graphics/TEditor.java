...
import animal.vhdl.logic.LogicT;
import animal.vhdl.logic.LogicVHDL;

/**
 * Editor for a T flip flop
 * 
 * @author p_li
 */
public class TEditor extends FillablePrimitiveEditor implements ItemListener,
	...
	protected void buildGUI() {
				...
				TitledBorder.LEADING, TitledBorder.TOP));
		{
			...
			Box inputBox = new Box(BoxLayout.PAGE_AXIS);
			{
				...
				{
					// set name label
					JLabel setLabel = new JLabel("T pin name: ");
					setBox.add(setLabel);
					// set name text
					setText = new JTextField("inT");
	...
	public void setProperties(XProperties props) {
		colorChooser.setColor(props.getColorProperty(PTT.T_FLIPFLOP_TYPE_LABEL + ".color",
				Color.black));
		depthBox.setSelectedItem(props.getProperty(PTT.T_FLIPFLOP_TYPE_LABEL + ".depth",
				"16"));
		fillColorChooser.setColor(props.getColorProperty(PTT.T_FLIPFLOP_TYPE_LABEL
				+ ".color", Color.black));
		filledCB.setSelected(props.getBoolProperty(PTT.T_FLIPFLOP_TYPE_LABEL + ".filled"));
	}

	public void getProperties(XProperties props) {
		props.put(PTT.T_FLIPFLOP_TYPE_LABEL + ".color", colorChooser.getColor());
		props.put(PTT.T_FLIPFLOP_TYPE_LABEL + ".depth", depthBox.getSelectedItem());
		props.put(PTT.T_FLIPFLOP_TYPE_LABEL + ".fillColor", fillColorChooser.getColor());
		props.put(PTT.T_FLIPFLOP_TYPE_LABEL + ".filled", filledCB.isSelected());
	}
	...
	public String getStatusLineMsg() {
		return AnimalTranslator.translateMessage("TEditor.statusLine",
	...
	private void setOutputValueOf(PTT ff) {
		...
		LogicT lT = new LogicT(inputList);
		char qv = booleanToChar(lT.getQValue());

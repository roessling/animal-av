...
/**
 * Handler for operations that can be performed on string arrays.
 */
public class StringArrayHandler extends GraphicObjectHandler {

	/**
	 * Get all the animation methods supported by a PTStringArray.
	 * 
	 * @param ptgo
	 *          a graphic object, i.e. a PTStringArray
	 * @param obj
	...
	public void propertyChange(PTGraphicObject ptgo, PropertyChangeEvent e) {
		// only works if the passed object is a PTStringArray!
		PTStringArray array = null;
		if (ptgo instanceof PTStringArray) {
			array = (PTStringArray) ptgo; // convert to PTStringArray

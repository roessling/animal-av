...
/**
 * Handler for operations that can be performed on IntArrays.
 */
public class IntArrayHandler extends GraphicObjectHandler {

	/**
	 * Get all the animation methods supported by a PTIntArray.
	 * 
	 * @param ptgo
	 *          a graphic object, i.e. a PTIntArray
	 * @param obj
	...
	public void propertyChange(PTGraphicObject ptgo, PropertyChangeEvent e) {
		// only works if the passed object is a PTIntArray!
		PTIntArray array = null;
		if (ptgo instanceof PTIntArray) {
			array = (PTIntArray) ptgo; // convert to PTIntArray

...
public class OpenCircleSegmentHandler extends GraphicObjectHandler {
	...
	public void propertyChange(PTGraphicObject ptgo, PropertyChangeEvent e) {
		// only works if the passed object is a PTPolyline!
		PTOpenCircleSegment shape = null;
		if (ptgo instanceof PTOpenCircleSegment)
			shape = (PTOpenCircleSegment)ptgo;

...
public class PTClosedCircleSegmentImporter extends PTGraphicObjectImporter {
  public Object importFrom(
  int version, StreamTokenizer stok) {
    PTClosedCircleSegment shape = new PTClosedCircleSegment();
    try {
      // parse square node
      ...
      parseFillAttributes(stok, shape, "ClosedCircleSegment");

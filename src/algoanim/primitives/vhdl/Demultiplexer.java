 ...
 */
public class Demultiplexer extends VHDLElement {
//	private DemultiplexerGenerator generator = null;
//
//	private Node upperLeft = null;
//
//	private int width = 0;
//
//	private VHDLElementProperties properties = null;
   ...
   * @param definedPins the list of VHDL pins (in, out, control, or bidirectional)
	 ...
	 */
	public Demultiplexer(VHDLElementGenerator sg, Node upperLeftCorner, int theWidth,

 ...
 */
public class DFlipflop extends VHDLElement {
//	private DFlipflopGenerator generator = null;
//
...
//	private VHDLElementProperties properties = null;
   ...
   * @param definedPins the list of VHDL pins (in, out, control, or bidirectional)
	 ...
	 */
	public DFlipflop(VHDLElementGenerator sg, Node upperLeftCorner, int theWidth,

...
public class IntMatrix extends MatrixPrimitive {
   ...
   * <code>CounterController</code> observes this <code>IntMatrix</code> it is
   * notified.
   * 
   * @param row
...
//   */
//  private int[] getRow(int row) throws IndexOutOfBoundsException {
...
//  }
  ...
  /**
   * Set the TextColor for a cell of an <code>IntMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the FillColor for a cell of an <code>IntMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the BorderColor for a cell of an <code>IntMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the HighlightTextColor for a cell of an <code>IntMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the HighlightFillColor for a cell of an <code>IntMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the HighlightBorderColor for a cell of an <code>IntMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col

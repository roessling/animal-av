...
/**
 * <code>StringMatrix</code> manages an internal matrix. Operations on objects
 * of <code>StringMatrix</code> are almost performed like on a simple matrix.
 * 
 * @author jens
 */
public class StringMatrix extends MatrixPrimitive {
  /**
   * The <code>StringMatrix</code> is internally represented by a simple
   * matrix.
   */
   ...
   *            the upper left corner of this <code>StringMatrix</code>.
   * @param matrixData
   *            the data of this <code>StringMatrix</code>.
   * @param name
   *            the name of this <code>StringMatrix</code>.
   * @param display
   *            [optional] the <code>DisplayOptions</code> of this
   *            <code>StringMatrix</code>.
   * @param iap
   *            [optional] the properties of this <code>StringMatrix</code>.
   */
  public StringMatrix(StringMatrixGenerator iag, Node upperLeftCorner,
      String[][] matrixData, String name, DisplayOptions display,
    ...
    if (matrixData == null) {
      throw new IllegalArgumentException(
          "Null matrix passed in to StringMatrix, named " + name);
    }
  ...
  private boolean checkForValidPosition(int row, int col, String methodName) {
    ...
    sb.append(methodName).append(" of class StringMatrix");
   ...
   * <code>CounterController</code> observes this <code>StringMatrix</code> it
   * is notified.
   * 
   * @param row
   ...
   */
  public void put(int row, int col, String what, Timing t, Timing d)
  ...
  public void swap(int sourceRow, int sourceCol, int targetRow,
    ...
    if (checkForValidPosition(sourceRow, sourceCol, "swap param 1")
      ...
      String tmp = data[sourceRow][sourceCol];
...
//   */
//  private String[] getRow(int row) throws IndexOutOfBoundsException {
...
//  }
  ...
  /**
   * Set the TextColor for a cell of an <code>StringMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the FillColor for a cell of an <code>StringMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the BorderColor for a cell of an <code>StringMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the HighlightTextColor for a cell of an <code>StringMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the HighlightFillColor for a cell of an <code>StringMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col
  ...
  /**
   * Set the HighlightBorderColor for a cell of an <code>StringMatrix</code>.
   * 
   * @param row
   *            the start row of the interval to unhighlight.
   * @param col

 ...
 * @author jens
 */
public class DoubleArray extends ArrayPrimitive {
	/**
	 ...
	 */
	public DoubleArray(DoubleArrayGenerator dag, Node upperLeftCorner,
			double[] arrayData, String name, ArrayDisplayOptions display,
			ArrayProperties iap) {
		super(dag, display);
	 ...
	 * <code>CounterController</code> observes this <code>DoubleArray</code> it
	 * is notified.
	 * 
	 * @param where
	 ...
	 */
	public void put(int where, double what, Timing t, Timing d)
	 ...
	 * <code>DoubleArray</code> it is notified.
	 * 
	 * @param what

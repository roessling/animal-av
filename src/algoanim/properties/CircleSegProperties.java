...
/**
 * Implements the properties for a generic "circle segment" shape. These objects
 ...
 * <dl>
 * <dt>ANGLE</dt>
 * <dd>the total angle of the circle segment</dd>
 * <dt>STARTANGLE</dt>
 * <dd>the starting angle of the circle segment</dd>
 * </dl>
 * 
 ...
 */
public class CircleSegProperties extends AnimationProperties implements
  ...
  public CircleSegProperties() {
    this("unnamed circleSeg property");
  }
   ...
   * 
   * @param name
   *          the name of this <code>CircleSegProperties</code>.
   */

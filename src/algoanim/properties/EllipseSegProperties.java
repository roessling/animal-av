...
/**
 * Implements the properties for a generic "ellipse segment" shape. These
 * objects possess the standard properties (COLOR, DEPTH, HIDDEN), the "shared"
 ...
 */
public class EllipseSegProperties extends AnimationProperties implements
    ArrowableAnimationProperties, ClosableAnimationProperties,
    FillableAnimationProperties, OrientedAnimationProperties {

  /**
   * Generates an unnamed <code>EllipseSegProperties</code> object.<
   */
  ...
  /**
   * Generates a named <code>EllipseSegProperties</code> object.
   * 
   * @param name
   *          the name of this <code>EllipseSegProperties</code>.
   */
  public EllipseSegProperties(String name) {
    super(name);
    fillHashMap();
  }

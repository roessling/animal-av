 ...
 */
public class AnimalDoubleMatrixGenerator extends AnimalGenerator implements
   ...
   */
  public boolean create(DoubleMatrix aMatrix) {
    if (isNameUsed(aMatrix.getName()) || aMatrix.getName().equals("")) {
      aMatrix.setName("DoubleMatrix" + AnimalDoubleMatrixGenerator.count);
      AnimalDoubleMatrixGenerator.count++;
    }
  ...
  public void highlightCellColumnRange(DoubleMatrix doubleMatrix, int row,
    ...
    // highlightgridcell "<id>[<line>][<column>]" <boolean> [timing]
    if (startCol == 0 && endCol == doubleMatrix.getNrCols() - 1 && cleverCode) {
  ...
  public void highlightCellRowRange(DoubleMatrix doubleMatrix, int startRow,
    ...
    boolean cleverCode = false;
    // highlightgridcell "<id>[<line>][<column>]" <boolean> [timing]
    if (startRow == 0 && endRow == doubleMatrix.getNrRows() - 1 && cleverCode) {
      StringBuilder sb = new StringBuilder(512);
      sb.append("highlightGridCell \"").append(doubleMatrix.getName());

...
public class VariableIncreaseExecutor extends Executor
{
	public VariableIncreaseExecutor(Variables vars, SourceCode src)
	{
		super(vars, src);
	}
	...
	{
		if(anno.getName().equalsIgnoreCase("inc"))
		{

...
it_IT.iconName=it_IT.gif
it_IT.label=Italiano
it_IT.locale=it IT
it_IT.mnemonic=i
it_IT.toolTipText=Trasnslate program into Italian
addItem.iconName=
addItem.label=Add Item
addItem.mnemonic=a
addItem.targetCall=
addItem.toolTipText=Add Item to List
addItem=Add Item
alignmentLabel=Alignment:
leftAlignment.iconName=
leftAlignment.label=Left alignment:
leftAlignment.mnemonic=l
leftAlignment.targetCall=
leftAlignment.toolTipText=
leftAlignment=left
centeredAlignment.iconName=
centeredAlignment.label=Centered alignment:
centeredAlignment.mnemonic=c
centeredAlignment.targetCall=
centeredAlignment.toolTipText=
centeredAlignment=centered
rightAlignment.iconName=
rightAlignment.label=Right alignment:
rightAlignment.mnemonic=r
rightAlignment.targetCall=
rightAlignment.toolTipText=
...
arcPropsBL=Arc Properties
ptrBoxBL=Pointer Box Colors
ptrPosBL=Pointer Position
textBL=Text
fontBL=Font Settings
colorBL=Color Settings
depthBL=Depth
nameBL=Object Name
windows.label=Windows
windows.mnemonic=w
windows.toolTipText=Provides access to the different windows used by Animal.
...
ErrorMissingKeyword=Keyword {0} was expected before {1} in line {2}. Trying to fix this...
...
ErrorFillColorBeforeFilled=Syntax Error before {0} in line {1}. \nAutocorrection: Correcting Code: ... filled fillcolor ...
...
intArrayStatusLine={0}: 1. click: create StringArray, 2. click: set position; {1}: finish; {2}: cancel
general=General
inactiveElementException=The chosen cell {0} is deactivated in the current animation step.\nPlease activate the cell at first using the highlight animator or choose another cell.
highlight.label=Highlight
highlight.mnemonic=h
highlight.toolTipText=Change the highlight state of the selected object(s)
noNumberException=Only integer values are allowed in an IntArray. The entered string '{0}' is not a number!
affectedCells=Affected cells: 
quizEval=In the {0} quizzes you took, you have reached {1} out of {2} possible points.
quizResults.iconName=Help.gif
quizResults.label=Quiz Results
quizResults.mnemonic=q
quizResults.toolTipText=Shows the results of the quizzes taken (if any)
animWinSizeIs=The current size of the Animation Window is {0}x{1}, including all active toolbars and scrollbars.
animWindowSize.iconName=Help.gif
animWindowSize.label=AnimationWindow size
animWindowSize.mnemonic=s
animWindowSize.targetCall=showAnimWindowSize
animWindowSize.toolTipText=Show the current size of the animation window
elemHighlightColorLabel=Element highlight color: 
put.label=Put
put.mnemonic=t
put.toolTipText=Enter a new value into an array cell
cellIndex=Cell Index: 
showIndices.iconName=
showIndices.label=Show cell indices
showIndices.mnemonic=i
showIndices.toolTipText=Turn display of cell indices on/off
swapType=Type of Swap:
swapTypeArc=Using PTArc
swapTypePolyline=Using PTPolyline
...
@import=versionInfo
garbageCollection.label=Garbage Collection
garbageCollection.mnemonic=g
garbageCollection.toolTipText=Collects garbage now. May take a while,\nbut may also free up system resources.
garbageCollection.iconName=
generator.label=Generate...
generator.mnemonic=g
generator.toolTipText=Generate a new animation
generator.iconName=gears.gif
arrayCell=Array cell: 
...
invalidCellSelection=The current cell selection is invalid.\nPlease select two different cells.
...
size=Size
stringArrayStatusLine={0}: 1. click: create StringArray, 2. click: set position; {1}: finish; {2}: cancel
swapCells=Cells to be swapped: 
swap.label=Swap
swap.mnemonic=s
swap.toolTipText=Swap two cells of an array
animateMenu.label=Animate...
animateMenu.mnemonic=a
animateMenu.toolTipText=Animate select objects(s)...
scale.label=Scale
scale.mnemonic=s
scale.toolTipText=Scales the currently selected object(s)
editItem.label=Edit
editItem.mnemonic=e
editItem.toolTipText=Edit the properties of the currently selected object(s)
move.label=Move
move.mnemonic=m
move.toolTipText=Moves the currently selected object(s)
colorchanger.label=Change Color
colorchanger.mnemonic=o
colorchanger.toolTipText=Changes the color for the currently selected object(s)
rotate.label=Rotate
rotate.mnemonic=r
rotate.toolTipText=Rotates the currently selected object(s)
timedshow.label=Hide / Show
timedshow.mnemonic=h
timedshow.toolTipText=Hides or shows the currently selected object(s)
deselect.label=Unselect
deselect.mnemonic=u
deselect.toolTipText=Unselects the currently selected object(s)
cloneItem.label=Clone
cloneItem.mnemonic=c
cloneItem.toolTipText=Clones the currently selected object(s)
deleteItem.label=Delete
deleteItem.mnemonic=d
deleteItem.toolTipText=Deletes the currently selected object(s)
showID.label=Show Object ID
showID.mnemonic=i
showID.toolTipText=Shows the IDs(s) for the currently selected object(s)
animalScriptCode.label=AnimalScript Code
animalScriptCode.mnemonic=l
animalScriptCode.toolTipText=Shows AnimalScript code for the currently selected object(s)
...
animInfo.label=About this Animation
animInfo.mnemonic=t
...
animOverview.toolTipText=Shows the animation overview window
animSpeed.iconName=
...
animWin.mnemonic=a
animWin.toolTipText=Shows the animation window
animWinReminder=To see the animation, please select "Show Animation Window" in the edit menu.
animalscript.iconName=Help.gif
animalscript.label=AnimalScript Definition
animalscript.mnemonic=s
animalscript.targetCall=showAnimalScriptDef
animalscript.toolTipText=Shows the AnimalScript definition
...
annotationWin.toolTipText=Shows the annotation window
...
drawWin.mnemonic=d
drawWin.toolTipText=Shows the drawing window
dynamicEx.iconName=
...
noObjectSelectedException=Please select one or more object(s)
...
objectsWin.toolTipText=Shows the object window
...
setfont.mnemonic=f
setfont.toolTipText=Set an object's font
settext.label=SetText
settext.mnemonic=t
settext.toolTipText=Set an object's text
...
timeLineWin.label=Show Table of Contents
timeLineWin.mnemonic=t
timeLineWin.toolTipText=Shows the table of contents (which may be empty)
totalLabel=Total: 
